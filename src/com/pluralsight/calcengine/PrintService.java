...
public interface PrintService extends Remote {
    ...
    // Real Functionality
    public void print (String filename, String printer) throws IOException;   // prints file filename on the specified printer
//    public String queue();   // lists the print queue on the user's display in lines of the form <job number>   <file name>
